...
export default function Page() {
  ...
  const columns: ProColumns<API_BRANDNAME_REPORT.Report>[] = [
    ...
    },
    {
      ...
      align: 'right',
      render: (item: any) => {
        return item?.viettel ? formatNumber(item?.viettel) : '';
      },
    },
    {
      title: 'Mobifone',
      ...
      align: 'right',
      render: (item: any) => {
        return item?.mobifone ? formatNumber(item?.mobifone) : '';
      },
    },
    {
      title: 'Vinaphone',
      ...
      align: 'right',
      render: (item: any) => {
        return item?.vinaphone ? formatNumber(item?.vinaphone) : '';
      },
    },
    {
      title: 'VietnamMobile',
      ...
      align: 'right',
      render: (item: any) => {
        return item?.vietnamobile ? formatNumber(item?.vietnamobile) : '';
      },
    },
    {
      title: 'Gmobile',
      ...
      align: 'right',
      render: (item: any) => {
        return item?.gmobile ? formatNumber(item?.gmobile) : '';
      },
    },
    {
      title: 'Itel',
      ...
      align: 'right',
      render: (item: any) => {
        return item?.itel ? formatNumber(item?.itel) : '';
      },
    },
    {
      title: 'Reddi',
      ...
      align: 'right',
      render: (item: any) => {
        return item?.reddi ? formatNumber(item?.reddi) : '';
      },
    },
    {
      title: 'Tổng cộng',
